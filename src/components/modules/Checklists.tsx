...
export const Checklists: React.FC<ChecklistsProps> = ({
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 pb-32">
      ...
      <Card className="rounded-[40px] bg-zinc-900 text-white border-none overflow-hidden relative group">
      ...
      <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between pt-4">
        <div>
          <h2 className="text-2xl font-serif italic text-zinc-900">Personalized Checklist</h2>
          <p className="text-sm text-zinc-500">Every detail, perfectly organized.</p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Dialog open={isCategoryDialogOpen} onOpenChange={setIsCategoryDialogOpen}>
            ...
            <DialogContent className="rounded-3xl">
              <DialogHeader>
                <DialogTitle className="font-serif italic text-2xl">Create New To Do List</DialogTitle>
              </DialogHeader>
              ...
              <DialogFooter>
                ...
                <Button onClick={handleAddCategory} className="rounded-xl bg-zinc-900 text-white hover:bg-zinc-800">Create Section</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
          ...
          <Dialog open={isEditCategoryDialogOpen} onOpenChange={setIsEditCategoryDialogOpen}>
            <DialogContent className="rounded-3xl">
              ...
              <DialogFooter>
                ...
                <Button onClick={handleUpdateCategoryTitle} className="rounded-xl bg-zinc-900 text-white hover:bg-zinc-800">Save Changes</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
          ...
          <Dialog open={isEditTaskDialogOpen} onOpenChange={setIsEditTaskDialogOpen}>
            <DialogContent className="rounded-3xl">
              ...
              <DialogFooter>
                ...
                <Button onClick={handleUpdateTaskTitle} className="rounded-xl bg-zinc-900 text-white hover:bg-zinc-800">Save Changes</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </div>
      ...
      {categories.length === 0 ? (
        <Card className="rounded-3xl border-2 border-dashed border-zinc-100 bg-zinc-50/50 py-12 text-center">
          <CheckSquare className="mx-auto h-12 w-12 text-zinc-300" />
          <h3 className="mt-4 text-lg font-bold text-zinc-900">Setting up your Roadmap...</h3>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-1">
                        <Button 
                          variant="ghost" 
                          size="icon" 
                          className="h-8 w-8 rounded-full text-zinc-400 hover:bg-zinc-100 hover:text-zinc-600"
                          onClick={(e) => {
                            e.stopPropagation();
                ...
                <AccordionContent className="px-6 pb-6 pt-2">
                  <div className="space-y-1">
                    {category.items.map((item) => (
                      <div 
                        key={item.id} 
                        className="group flex items-center justify-between rounded-2xl p-3 transition-colors hover:bg-zinc-50 cursor-pointer"
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          />
                          <span className={`text-sm select-none transition-all ${item.completed ? 'text-zinc-400 line-through' : 'text-zinc-700 font-medium'}`}>
                            {item.title}
                          </span>
                        </div>
